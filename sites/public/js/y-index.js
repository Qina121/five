$(document).ready(function() {
  ...
  //调用函数
    ...
    var modelTop = (Height-bannerModel.height())/2;
...
bannerBlock.mouseenter(function() {
  var index = $(this).index();
  bannerBlock.stop().animate({ opacity: "0" }, 300,function(){
    bannerBlock.css('display','none');
    console.log(bannerDetail.eq(index));
    bannerDetail.eq(index).css('display','block');
    bannerDetail.eq(index).stop().animate({ "opacity": "1" }, 300);
  });
